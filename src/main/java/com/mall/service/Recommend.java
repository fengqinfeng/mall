...
//        List<RecommendedItem> recommendedItemList = recommender.recommendedBecause(1, 6, 10);
//        //打印推荐的结果
...
//        //recommendedItemList = recommender.recommendedBecause(5, 32, 10);
//        //打印推荐的结果
////        System.out.println("使用基于物品的协同过滤算法");
////        System.out.println("根据用户5当前浏览的商品32，推荐10个相似的商品");
////        for (RecommendedItem recommendedItem : recommendedItemList) {
////            System.out.println(recommendedItem);
////        }
...
//    }
    public List<RecommendedItem> recommend(long userid,long itemid)throws Exception{
        ...
        try {
            ...
            GenericItemBasedRecommender recommender = new GenericItemBasedRecommender(dataModel, itemSimilarity);
            //给用户ID等于5的用户推荐10个与2398相似的商品
            List<RecommendedItem> recommendedItemList = recommender.recommendedBecause(userid, itemid, 10);
